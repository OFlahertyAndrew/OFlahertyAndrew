...
#
 ...
 <h3>🌥 Background</h3>
   ...
   I started my journey at the age of 11 with Visual Basic 2008. The first substantial project I completed was antivirus software that used a database of md5 hashes to scan files in real-time, as well as when a system scan was requested by the user. Since then, I've further developed my knowledge through my B.S. in Computer Programming and Information Systems. I've developed software using C++, Java, C#, and most other popular languages. I also have experience with web development languages such as HTML, CSS, Bootstrap, and JavaScript. Python, however, has grown to be my language of choice. Python is abundantly powerful, functional within many fields of the tech industry, and very beginner friendly. I've spent most of my recent time creating projects with Python, teaching others, and learning as much as possible.
